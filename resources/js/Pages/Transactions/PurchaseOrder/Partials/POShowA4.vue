...
>
    ...
    <table class="w-full border border-gray-400 mb-6 relative z-10">
        <thead class="bg-gray-100 border-b-2 border-gray-400">
            <tr>
                ...
                <th class="border border-gray-400 px-2 py-2 w-[70px] text-right">Qty</th>
                <th class="border border-gray-400 px-2 py-2 w-[100px] text-right">Unit Price</th>
    ...
    <div class="grid grid-cols-2 gap-10 mt-16 text-sm relative z-10">
        ...
        <div>
            ...
            <div class="mt-12 border-t-2 border-gray-300 pt-2 text-xs text-gray-400">
                Signature
                <br>
                Date:
            </div>
