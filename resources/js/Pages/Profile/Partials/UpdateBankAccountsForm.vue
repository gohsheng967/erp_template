...
const bankAccounts = computed(() => user.value.bank_accounts ?? [])
...
function submit() {
    form.post("/profile/bank-accounts", {
        preserveScroll: true,
        onSuccess: () => {
            form.reset()
...
function toggleStatus(account) {
    ...
    router.patch(`/profile/bank-accounts/${account.id}`, {
        status: nextStatus,
    }, {
        preserveScroll: true,
        onSuccess: () => {
...
function removeAccount(account) {
    router.delete(`/profile/bank-accounts/${account.id}`, {
        preserveScroll: true,
        onSuccess: () => {
    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Add and manage your bank accounts for payments.
            </p>
        </header>
