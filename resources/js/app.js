...
import { capitalize, titleCase, formatCurrency, formatDate, formatDateTime, amountToWords } from './helpers/string'
...
createInertiaApp({
    ...
    setup({ el, App, props, plugin }) {
        ...
        app.config.globalProperties.$amountToWords = amountToWords
